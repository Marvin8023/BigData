...
//        输入文件
        FileInputFormat.setInputPaths(job, new Path("/hadoop_test/min_max/avg.txt"));

        if( hadoopHelp.testExist(conf,"/hadoop_test/min_max/result")){
            hadoopHelp.rmDir(conf,"/hadoop_test/min_max/result");}
